...
BallEntity * MakeBall(Sprite *sprite)
{
	...
	dynamicBall.m_radius = 16.f / (2 * PTM_RATIO); //ball has diameter of 9 pixels
	...
	fixtureDef.filter.maskBits = CMASK_SPINNER | CMASK_BALL | CMASK_PADDLE | CMASK_EDGES | CMASK_BRICK | CMASK_GROUND;//it collides wth lotsa stuff
