...
PaddleEntity * MakePaddle(float xpos, float ypos, Sprite *sprite)
{
	...
	boxShape.SetAsBox(128.0f / (2.f*PTM_RATIO), 16.0f / (2.f*PTM_RATIO));
	...
	paddleFixtureDef.filter.maskBits = CMASK_BALL | CMASK_POWERUP | CMASK_EDGES;//it collides with balls and powerups and edge of the screen
